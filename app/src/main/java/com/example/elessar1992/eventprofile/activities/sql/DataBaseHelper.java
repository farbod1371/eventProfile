package com.example.elessar1992.eventprofile.activities.sql;
...
public class DataBaseHelper extends SQLiteOpenHelper
{
    ...
    public static final String COL_passwod = "Password";
    ...
    private String CREATE_USER_TABLE2 = "CREATE TABLE " + TABLE_NAME + "("
            ...
            + COL_email + " TEXT," + COL_passwod + " TEXT" + ")";
    ...
    public void addUser(User user)
    {
        ...
        values.put(COL_passwod, user.getPassword());
    ...
    public List<User> getAllUser()
    {
...

        {
            do {
                ...
                user.setPassword(cursor.getString(cursor.getColumnIndex(COL_passwod)));
                userList.add(user);
            }
    ...
    public void insertdata(User user)
    {
        ...
        contentValues.put(COL_passwod, user.getPassword());
    ...
    public boolean checkUser(String email, String password)
    {
        ...
        SQLiteDatabase db = this.getReadableDatabase();
        String myQuery =  COL_email + " = ?" + " AND " + COL_passwod + " = ?";
